    ...
    <div id="block">
        ...
        <section id="about">
            <div>
                ...
                <p>
                    Our aim was to make bus booking a simple and easy task just like we are booking a plane or a train ticket.
                    In this prototype Model we have tried to demonstrate that how easily we can get to know about different routes of buses and book them. 
                </p>
            </div>
        </section>
        <section id="contact">
        ...
        <footer>
        <p>
                        <i class="far fa-copyright"></i> <?php echo date('Y');?> - Transport Enquiry System | Made with &#10084;&#65039; by 3rd Year Students-IIIT Bhagalpur
                        </p>
        </footer>
    </div>
